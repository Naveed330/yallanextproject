    ...
    return (
        <Container fluid>
            {/* <div className='cardPartnerContainer' style={{ marginTop: '7%' }} >
                <Row className="mt-5">
                    <h4 className='productTag mt-4' style={{ textAlign: 'center' }} data-aos="fade-up" >Blogs</h4>
                    <h4 className='blognews' data-aos="fade-up" >Blogs & News About <span className='vendertag' >Vending</span> Industry</h4>
                    {CardData.map((card, index) => (
                        <Col key={index} xs={12} md={6} lg={4} className="mb-4 mt-4">
                            <Card style={{ border: 'none' }} className='cardBlog' data-aos="fade-up">
                                <Image
                                    variant="top"
                                    src={card.imageUrl}
                                    alt="cardblogimage"
                    ...
                    <div style={{ display: 'flex', justifyContent: 'end', flexDirection: 'column', alignItems: 'end', marginTop: '60px' }} data-aos="fade-up">
                ...
                <Row style={{ marginTop: '7%' }}>
                    ...
                    <div className='partnerContainer' data-aos="fade-up">
